...
M.keys = {
  ...
  { "gD", function() require("mini.extra").pickers.lsp({ scope = "declaration" }, { reuse_win = true }) end, desc = "Goto Declaration" },
  { "gd", function() require("mini.extra").pickers.lsp({ scope = "definition" }, { reuse_win = true }) end, desc = "Goto Definition" },
